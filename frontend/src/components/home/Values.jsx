  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto animate-fade-in delay-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-light dark:bg-gray-800 rounded-xl p-6 border-2 border-accent dark:border-accent-secondary hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <h4 className="text-xl font-bold text-accent dark:text-accent-secondary mb-3 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto mb-12 animate-fade-in delay-100">
          {values.map((value, index) => (
            <div
              key={index}
              className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] bg-light dark:bg-gray-800 rounded-xl p-6 border border-accent/30 dark:border-accent-secondary/30 hover:border-accent dark:hover:border-accent-secondary hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
